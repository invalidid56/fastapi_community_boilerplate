...
Revision ID: 86e80fe95bb8
Revises: c25fc94b9bc1
Create Date: 2023-12-05 14:48:40.534162
...
revision: str = '86e80fe95bb8'
down_revision: Union[str, None] = 'c25fc94b9bc1'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_board_title'), 'board', ['title'], unique=True)
